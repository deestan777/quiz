...
<body>
    ...
    <style>
        ...
        body {
  background: linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url("thanks/bg.png") no-repeat center/cover;
    ...
    <main style="padding-top: 20px; padding-bottom: 20px;">
        <img class="logo" src="thanks/logo.jpg" width="150" height="80" alt="gazprom logo">
        ...
        <p class="text">Команда Maib уже приняла в работу Вашу заявку! С Вами свяжется менеджер платформы в
            течение
            48
            часов.</p>
